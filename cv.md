...
## *About me:*
I have been working as a doctor for four years now. I completed retraining as a sport's medicine doctor. During my study in university I took a course in sound engineering, that's my hobby passion. I also worked as a volunteer at a half marathon. Also I worked as a doping control officer at the CIS Games during my job. Now I am trying myself in front-end development on JavaScript and I like it, coding is my favorite part. I am a diligent and goal-oriented student, capable of learning and open to new things. My goal in studying is to achieve a sufficient level of knowledge to change current job without forgetting about the principles of work-life balance.
...
1. [CV page only with markdown](https://Is-tukan.github.io/rsschool-cv/cv); [CV repository only with markdown](https://github.com/Is-tukan/rsschool-cv/tree/gh-pages?tab=readme-ov-file)
2. [CV page](https://Is-tukan.github.io/rsschool-cv/); [CV repository](https://github.com/Is-tukan/rsschool-cv/tree/rsschool-cv-html?tab=readme-ov-file)
3. [Project 'Shelter'](https://rolling-scopes-school.github.io/is-tukan-JSFEPRESCHOOL2024Q2/shelter/pages/main/)
...
8. [JavaScript / Front-end Course. Pre-school](https://rs.school/courses/javascript-preschool-ru) in progress...
9. [JavaScript / Front-end Course](https://rs.school/courses/javascript-ru) in progress...

## *English level:*
![](assets/1631348364654.jfif "English level sertificate") [Official certificate EF SET 59/100 (B2 Upper Intermediate)](https://cert.efset.org/MCEUFh)
